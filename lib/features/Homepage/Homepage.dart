...
class _HomePageState extends State<HomePage> {
  ...
  late Future<MemberSummary> memberSummaryFuture;

  @override
  void didChangeDependencies() {
    super.didChangeDependencies();
    checkForMeeting();
    memberSummaryFuture = fetchMemberSummary();
  }

  Future<MemberSummary> fetchMemberSummary() async {
    try {
      final results = await comms.getRequests(endpoint: "members/dashboard");
      if (results["rsp"]["success"]) {
        return MemberSummary.fromJson(results["rsp"]["dashboard"]["stats"]);
      } else {
        throw Exception(results["rsp"]["message"]);
      }
    } catch (e) {
      debugPrint('Error fetching member summary: $e');
      throw e;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor:
          colorScheme.background, // Use background for a softer base
      appBar: AppBar(
        backgroundColor: Colors.transparent,
        elevation: 0,
        systemOverlayStyle:
            SystemUiOverlayStyle
                .dark, // Adjust based on your primary background
        title: Column(
          ...
          children: [
            Text(
              ...
              style: theme.textTheme.headlineSmall?.copyWith(
                ...
                color:
                    colorScheme.onBackground, // Use onBackground for text color
              ),
            ),
            Text(
            ...
            children: [
              ...
              FutureBuilder<MemberSummary>(
                ...
                builder: (context, snapshot) {
                  ...
                  final memberSummary = snapshot.data!;
                  return Container(
                    width: double.infinity,
                    padding: const EdgeInsets.symmetric(
                      vertical: 32,
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              'KSh ${memberSummary.totalContributed.toStringAsFixed(2)}',
              ...
              const SizedBox(
                height: 40,
              ), // More vertical space before next section
              // Quick Actions Grid (Refined)
              Text(
                'Your Group Services', // More professional heading
            ...
            style: theme.textTheme.bodyLarge?.copyWith(
              ...
              color:
                  isPositive
                      ...
                      : colorScheme.error, // Stronger green
              letterSpacing: 0.5,
            ),
          ),
        ],
  ...
  Widget _buildActionButton(
    ...
    return InkWell(
      ...
      borderRadius: BorderRadius.circular(
        18,
      ), // Larger borderRadius for smooth touch
      child: Container(
        ...
        Text(
          ...
          style: theme.textTheme.bodyMedium?.copyWith(
            ...
            fontWeight:
                isImportant
                    ? FontWeight.w600
                    : FontWeight.normal, // Slightly less bold for normal
          ),
        ),
        const SizedBox(width: 8),
        Expanded(
          // Ensures text wraps if long
          child: Text(
            value,
